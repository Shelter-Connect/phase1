...
import '../components/secondary_rounded_button.dart';
        ...
        body: Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                SecondaryRoundedButton(title: 'Change e-mail Address', onPressed: (){
                  //TODO: Get rid of Firebase user when this button is clicked
                  Navigator.pushNamed(context, '/volunteer_sign_up');
                },),
                SizedBox(height: 30),
                SecondaryRoundedButton(title: 'Resend Verification E-mail', onPressed: (){
                  //TODO: Resend Verification E-mail
                },),
                SizedBox(height: 50),
                RoundedButton(title: 'Continue', onPressed: (){
