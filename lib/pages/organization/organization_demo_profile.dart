...
class OrganizationDemoPage extends StatefulWidget {
  final Organization organization;

  OrganizationDemoPage(this.organization);

  @override
  _OrganizationDemoPageState createState() => _OrganizationDemoPageState();
}

class _OrganizationDemoPageState extends State<OrganizationDemoPage> {
  bool loading = true;
