...
class VolunteerNavigationPage extends StatefulWidget {
  @override
  _VolunteerNavigationPageState createState() =>
      _VolunteerNavigationPageState();
}
      ...
      child: MultiProvider(
        providers: [
          StreamProvider<List<Organization>>.value(
            value: db.collection('organizations').snapshots().map((snapshot) {
              ...
              for (DocumentSnapshot document in snapshot.documents) {
                ...
                organizations.add(Organization.fromFirestoreMap(
                    context: context,
                    organizationSnapshot: document,
                    isVolunteer: false));
              }
          ...
          StreamProvider<List<Donation>>.value(
            value: FirestoreHelper.getCurrentVolunteerReference(context)
        ...
        child: WillPopScope(
          ...
          child: Scaffold(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            Visibility(
                              visible:
                                  _tabs[_selectedIndex].helpDescription != '',
                              child: IconButton(
            ...
            bottomNavigationBar: SizedBox(
              height: MediaQuery.of(context).size.height / 18 + 25,
